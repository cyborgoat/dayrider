        ...
        >
          <ListboxItem key="todo" href={"/todo"} textValue={"todo"}>
            <div className="flex flex-row">
              <TodoIcon /> <span className="ml-1 text-md">Todo</span>
            </div>
          </ListboxItem>
          <ListboxItem key="schedule" href={"/schedule"} textValue={"schedule"}>
            <div className="flex flex-row">
              <CalendarIcon /> <span className="ml-1 text-md">Schedule</span>
            </div>
          </ListboxItem>
        </Listbox>
      </div>
      ...
      >
        ...
        >
          <ListboxItem key="schedule" href={"/profile"} textValue={"schedule"}>
            <div className="flex flex-row">
              <PersonIcon /> <span className="ml-1 text-md">My Profile</span>
            </div>
          </ListboxItem>
          <ListboxItem key="settings" href={"/settings"} textValue={"settings"}>
            <div className="flex flex-row">
              <SettingsIcon /> <span className="ml-1 text-md">Settings</span>
            </div>
          </ListboxItem>
        </Listbox>
      </div>
